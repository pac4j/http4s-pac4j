...
It's based on Http4s 0.22 and on the **[pac4j security engine](https://github.com/pac4j/pac4j) v5**. The library is cross-built for Scala 2.12 and 2.13. It's available under the Apache 2 license.
